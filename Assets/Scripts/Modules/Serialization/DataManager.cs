...
namespace Metroidvania.Serialization
{
    ...
    public class DataManager : ScriptableSingleton<DataManager>, IInitializableSingleton
    {
        ...
        {
            // Add null check to prevent errors during application quit
            if (_gameData != null)
            {
        ...
        {
            // Add safety checks to prevent NullReferenceException during cleanup
            if (_gameData == null || s_dataHandler == null)
                return;
